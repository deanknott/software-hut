...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ...
    Rails.application.load_seed # load seed data to test db
  end

  # Cleans/empties the test db after tests
...
Capybara.register_driver :poltergeist do |app|
  Capybara::Poltergeist::Driver.new(app, phantomjs_logger: PoltergeistWarningSuppressor,phantomjs: Phantomjs.path)
end
